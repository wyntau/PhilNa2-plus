...
?>
	...
	<tbody>
		<tr valign="top" style="border-bottom: 2px solid #fff;">
			...
			<td>
				<input id="homeslide" name="homeslide" type="checkbox" value="checkbox" <?php if($o['homeslide']) echo "checked='checked'"; ?> /><br/>
				<label for="homeslide">勾选则首页文章伸缩,否则为Ajax加载</label><br/>
				<input id="no_home_slide" name="no_home_slide" type="checkbox" value="checkbox" <?php if($o['no_home_slide']) echo "checked='checked'"; ?> /><br/>
				<label for="no_home_slide">关闭首页文章伸缩以及Ajax加载效果(勾选此项会使上面的选择失效,首页无伸缩,无Ajax加载)</label><br/>
			</td>
		</tr>
		 <tr valign="top" style="border-bottom: 2px solid #fff;">
...
如需使用google自定义搜索,请在后台添加页面,选择”google搜索结果页面“模板,并将此模板的地址设为cse,<br/>比如我的网址为http://isayme.com.则google自定义搜索结果页面的链接为http://isayme.com/cse 切记!!
		...
		<tr valign="top" style="border-bottom: 2px solid #fff;">
			...
			<td><input id="enable_google_analytics" name="enable_google_analytics" type="checkbox" value="checkbox" <?php echo $o['enable_google_analytics'] ? "checked='checked'" : '';?>/>
		...
		<tr valign="top">
			...
			<label>
			帅哥名单(两个邮箱之间用英文逗号隔开)
			<textarea name="handsome" id="handsome" cols="50" rows="2" style="width:98%;font-size:12px;"><?php echo($o['handsome']); ?></textarea>
			</label><br/>
			<label>
			美女名单(两个邮箱之间用英文逗号隔开)
			<textarea name="beauty" id="beauty" cols="50" rows="2" style="width:98%;font-size:12px;"><?php echo($o['beauty']); ?></textarea>
			</label>
			</td>
		</tr>
		...
		<tr valign="top">
			...
			<textarea name="philna_say" id="philna_say" cols="50" rows="8" style="width:98%;font-size:12px;"><?php echo($o['philna_say']); ?></textarea>
			</label>
			</td>
		</tr>
	</tbody>
